...
CUSTOM_MODEM = S7S88B7-LWCTG_6785-G2358W12458F123457812131718192025262866T3840_hotswap-B
...
MTK_ATF_SUPPORT = yes
MTK_AUDIO = yes
#prize add by lipengpeng 20201109 start 
MTK_AUDIODSP_SUPPORT = no
#prize add by lipengpeng 20201109 end 
...
#prize add by lipengpeng 20210206 start
...
#prize modify by YZHD,open fm antenna support,20210221
...
#prize modified by tangan,enable mtklog-20200925-begin
MTK_LOG_CUSTOMER_SUPPORT = yes
#prize modified by tangan,enable mtklog-20200925-end
...
#prize add by lipengpeng  2019124 start
MTK_NFC_ADDON_SUPPORT = no
#prize add by lipengpeng  2019124 end
...
#prize modify by YZHD,Set to no to solve CTS fail,20201118,begin
MTK_OMAPI_SUPPORT = yes
#prize modify by YZHD,Set to no to solve CTS fail,20201118,end
...
#prize modified by tangan,enable signature-20200925-begin
MTK_SIGNATURE_CUSTOMIZATION = yes
#prize modified by tangan,enable signature-20200925-end
...
#prize modify by YZHD,remove wma to solve CTS fail,20201118,begin
MTK_WMA_PLAYBACK_SUPPORT = no
#prize modify by YZHD,remove wma to solve CTS fail,20201118,end
...
#prize add by lipengpeng 20191227 start
ST_NFC_CHIP_VERSION =ST21NFCD
#prize add by lipengpeng 20191227 end
...
#prize-lanweiming-20200925,add PRIZE_SW_VERSION-start
PRIZE_SW_VERSION=S7S68B7.GQU.Ulefone.HB.HJ.$(PRIZE_FLASH_CODE).$(shell date +%Y%m%d).V3.02
#prize-lanweiming-20200925,add PRIZE_SW_VERSION-end
...
#整机测试免测项，以,号分隔.具体配置值参考com.pri.factorytest.util.Utils,如指纹fingerprint,后摄rear_camera，不支持删除LCD
PRIZE_DELETE_MOBILE_TEST_ITEMS =
#自动化测试开关(参考值为yes或者no,yes:应用编入到系统,no:不编译)
PRIZE_AUTOTEST_APP = no
#自动化测试项结果显示 (人工测试01 MMI自动化测试 02 camera自动化测试 04 音频自动化测试 08)
#(都显示配置01+02+04+08=15,音频+人工01+08=9,不显示配置0，空默认8)
#PRIZE_AUTOTEST_SHOW_RESULTS = 9
...
PRIZE_FUNCTION_KEY    =PTT_RECORD,POWER
#工厂测试是否显示语言切换按钮
...
PRIZE_BOARD_NETWORK_TYPE = GB/WB/LfB/LtB
...
#大于等于2颗后摄，只是1真1假不需要开宏
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB=yes
#大于等于3颗后摄,或者2颗真后摄+1颗假后摄
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB2=yes
#大于等于4颗后摄
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB3 = no
#8804 TEE环境,指纹测试 1 设置密码生成Token, 0 固定Token
PRIZE_FINGERPRINT_MODULE  = 0
#
...
#driver modified
CUSTOM_HAL_IMGSENSOR = s5k4h7yx_mipi_raw imx582_mipi_raw s5k3p3sx_mipi_raw gc02m2_mipi_raw s5kgm1st_mipi_raw s5kgm1stgms_mipi_raw s5k3p3sxgms_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc02m2_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR =  imx582_mipi_raw s5kgm1st_mipi_raw s5kgm1stgms_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p3sx_mipi_raw s5k3p3sxgms_mipi_raw
CUSTOM_KERNEL_IMGSENSOR = s5k4h7yx_mipi_raw imx582_mipi_raw s5k3p3sx_mipi_raw gc02m2_mipi_raw s5kgm1st_mipi_raw s5kgm1stgms_mipi_raw s5k3p3sxgms_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc02m2_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR =  imx582_mipi_raw s5kgm1st_mipi_raw s5kgm1stgms_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR =  s5k3p3sx_mipi_raw s5k3p3sxgms_mipi_raw
...
#TEE防呆免加密狗 不显示TEE激活状态
#PRIZE_DOUJIA_DOG_FREE = yes
#prize add by lipengpeng 硬件计步导致CTS fail，解决问题用此宏控制
PRIZE_HW_STEP_COUNTER_FOR_GMS = yes

#add by liaojie 20210306  for fingerprint icnf7232  start
PRIZE_FINGER_PRINT = fortsense_tee_none_android11
MTK_TEE_SUPPORT = yes
...
#add by liaojie 20210306  for fingerprint icnf7232  end
...
#屏幕密度
PRIZE_LCD_DENSITY=480

#地磁校准
PRIZE_MSENSOR_CALI = yes
